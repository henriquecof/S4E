/****** Object:  Procedure [dbo].[SP_FechaProcessoBancos]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[SP_FechaProcessoBancos] 
...
BEGIN
	...
	**/
    ...
    Declare @WL_dsOcorrencia varchar(1000)
		...
		Begin -- 3.1
			...
			if isnull(@fl_BaixaRetorno,0)>0 
			   ...
			   begin			    
					...
					---Ocorrencia
					set @WL_dsOcorrencia = 'CONFORME ARQUIVO DE ENVIO - LOTE ' +  convert(varchar(50),@sequencial) + ' PROCESSADO EM ' +  convert(varchar(10),GETDATE(),103) + ', PARCELA DE VENC. ' + convert(varchar(10),@dt_Vencimento, 103) + ', O DEBITO NAO FOI EFETUADO: ' + convert(varchar(50),@WL_dsOcorrencia)  + '.'
