/****** Object:  Function [dbo].[FS_CalculoModulo11_CNAB240]    Committed by VersionSQL https://www.versionsql.com ******/

create Function [dbo].[FS_CalculoModulo11_CNAB240](@valor Varchar(30), @anexo int)
RETURNS varchar(1)
AS
Begin
    Declare @tamanho int
