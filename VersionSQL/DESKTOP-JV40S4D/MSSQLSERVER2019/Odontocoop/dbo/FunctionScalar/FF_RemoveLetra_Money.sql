/****** Object:  Function [dbo].[FF_RemoveLetra_Money]    Committed by VersionSQL https://www.versionsql.com ******/

create FUNCTION [dbo].[FF_RemoveLetra_Money](@Texto varchar(8000)) returns varchar(8000)  
AS  
BEGIN
